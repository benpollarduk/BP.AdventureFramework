...
namespace BP.AdventureFramework.DemoQuest
{
    public static class Flat
    {
        ...
        {
            var flat = new Region("Flat 3", "Ben and Beth's Flat");
            ...
            var hallway1 = new Room("Eastern Hallway",
            ...
            var hallway2 = new Room("Western hallway",
            ...
            var mug = new Item("Empty Coffee Mug", "A coffee mug. It has an ugly hand painted picture of a man with green hair and enormous sideburns painted on the side of it. Underneath it says 'The Sideburn Monster Rides again'. Strange", true)
            {
                Interaction = (i, target) =>
                {
                    if (i == null)
                    ...
                    switch (i.Name.ToUpper())
                    {
                        case "KETTLE":
                            ...
                            item?.Morph(new Item("Mug Of Coffee", "Hmmm smells good, nice and bitter!", true));
            ...
            var roof = new Room("Faustos Roof",
            ...
            var bedroom2 = new Room("Spare bedroom",
                new Description(string.Empty),
                new[] { new Exit(CardinalDirection.North) },
            ...
            var kitchen = new Room("Kitchen",
                ...
                new Item("Hamster Cage", "There is a pretty large hamster cage on the floor. When you go up to it you hear a small, but irritated sniffing. Mable sounds annoyed, best leave her alone for now.", false),
                kettle)
            {
                Interaction = (i, target) =>
                {
            ...
            var beth = new NonPlayableCharacter("Beth", "Beth is very pretty, she has blue eyes and ginger hair. She is sat on the sofa watching the TV", new Conversation("Hello Ben", "You have a big dong"));
            ...
            var flatWorld = new Overworld("Smalltown", "A sleepy town");
