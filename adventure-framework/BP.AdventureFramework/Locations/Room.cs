...
namespace BP.AdventureFramework.Locations
{
    ...
    public class Room : GameLocation, IInteractWithItem, IImplementOwnActions
    {
        ...
        /// Get the exits.
        /// </summary>
        public List<Exit> Exits { get; protected set; }
        ...
        /// </summary>
        public List<NonPlayableCharacter> Characters { get; protected set; }
        ...
        private static string GetObjectifier(string word)
        {
        ...
        public override ExaminationResult Examime()
        {
            ...
            if (Items.Where(i => i.IsPlayerVisible).ToArray().Length == 1)
            {
                ...
                return new ExaminationResult($"There {(IsPlural(singularItem.Name) ? "are" : "is")} {GetObjectifier(singularItem.Name)} {singularItem.Name}");
            }

            var itemsInList = GetItemsAsString();
            ...
            while (somethingLeftToCheck)
            {
                ...
                if (index == sentance.LastIndexOf(", ", StringComparison.Ordinal))
                {
                    ...
                    sentance = sentance.Insert(index, $" and {GetObjectifier(currentItemName)} ");
                ...
                else
                {
                    ...
                    sentance = sentance.Insert(index, $", {GetObjectifier(currentItemName)} ");
                    index += 1;
                }
            }
            ...
            return new ExaminationResult($"There {(IsPlural(currentItemName) ? "are" : "is")} {GetObjectifier(currentItemName)} {sentance}");
        }
