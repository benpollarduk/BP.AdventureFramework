...
using BP.AdventureFramework.Structure;

namespace BP.AdventureFramework.IO
{
    /// <summary>
    ...
    public class TextParser
    {
        ...
        /// <returns>The result of the parse.</returns>
        public bool TryParseToECommand(string obj, out Command command)
        {
        ...
        /// <param name="command">The command.</param>
        /// <returns>The result of the parse.</returns>
        public bool TryParseToEGameCommand(string obj, out GameCommand command)
        {
        ...
        public virtual ReactionToInput ReactToInput(string input, Game game, out string result)
        {
            ...
            if (IsCommand(noun))
            {
                TryParseToECommand(noun, out var command);
