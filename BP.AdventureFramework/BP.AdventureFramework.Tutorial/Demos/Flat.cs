...
namespace BP.AdventureFramework.Tutorial.Demos
{
    public static class Flat
    {
        ...
        {
            var flat = new Region("Flat 3".ToIdentifier(), "Ben and Beth's Flat".ToDescription());
            ...
            var mug = new Item("Empty Coffee Mug".ToIdentifier(), "A coffee mug. It has an ugly hand painted picture of a man with green hair and enormous sideburns painted on the side of it. Underneath it says 'The Sideburn Monster Rides again'. Strange".ToDescription(), true)
            {
                Interaction = (i, target) =>
                {
                    if (i == null)
                    ...
                    switch (i.Identifier.IdentifiableName)
                    {
                        case "KETTLE":
                            ...
                            item?.Morph(new Item("Mug Of Coffee".ToIdentifier(), "Hmmm smells good, nice and bitter!".ToDescription(), true));
            ...
            var roof = new Room("Faustos Roof".ToIdentifier(),
                ...
                new Item("Sky light".ToIdentifier(), "You peer down into the skylight, only to see a naked Italian man... cooking! Yikes! Not liking the idea of the accidents one could get into by cooking naked you look away quickly".ToDescription(), false),
                mug);
            ...
            var bedroom2 = new Room("Spare bedroom".ToIdentifier(),
                ...
                new Item("Guitar".ToIdentifier(), "The guitar is blue, with birds inlaid on the fret board. On the headstock is someones name... 'Paul Reed Smith'. Who the hell is that. The guitar is litteraly begging to be played...".ToDescription(), true));
                    ...
                    if (obj != null)
                    {
                        switch (i.Identifier.IdentifiableName)
                        {
                            case "EMPTY COFFEE MUG":
                                ...
                                i.Morph(new Item("Mug Of Coffee".ToIdentifier(), "Hmm smells good, nice and bitter!".ToDescription(), true));
            ...
            var kitchen = new Room("Kitchen".ToIdentifier(),
                ...
                new Item("Hamster Cage".ToIdentifier(), "There is a pretty large hamster cage on the floor. When you go up to it you hear a small, but irritated sniffing. Mable sounds annoyed, best leave her alone for now.".ToDescription(), false),
                kettle)
            {
                Interaction = (i, target) =>
                {
                ...
                if (obj != null)
                {
                    switch (i.Identifier.IdentifiableName)
                    {
                        case "MUG OF COFFEE":
                            ...
                            i.Morph(new Item("Empty Coffee Mug".ToIdentifier(), "A coffee mug. It has an ugly hand painted picture of a man with green hair and enormous sideburns painted on the side of it. Underneath it says 'The Sideburn Monster Rides again'. Strange.".ToDescription(), true));
