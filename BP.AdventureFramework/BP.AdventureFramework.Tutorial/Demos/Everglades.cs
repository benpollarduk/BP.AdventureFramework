...
namespace BP.AdventureFramework.Tutorial.Demos
{
    public static class Everglades
    {
        ...
        public static Overworld GenerateOverworld()
        {
            ...
            r.CreateRoom(new Room("Great Western Ocean".ToIdentifier(), new Description("The Great Western Ocean stretches to the horizon. The shore runs to the north and south. You can hear the lobstosities clicking hungerly. To the east is a small clearing"), new[] { new Exit(CardinalDirection.East) }, conchShell), 1, 2);
            r.CreateRoom(new Room("Cave".ToIdentifier(), new Description("The cave is so dark you struggling to see. A screeching noise is audible to the east"), new Exit(CardinalDirection.South), new Exit(CardinalDirection.East)), 2, 3);
