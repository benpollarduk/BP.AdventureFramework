...
{
    /// <summary>
    /// Provides a builder for legacy completion frames.
    /// </summary>
    public sealed class LegacyCompletionFrameBuilder : ICompletionFrameBuilder
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the LegacyCompletionFrameBuilder class.
        /// </summary>
        /// <param name="lineStringBuilder">A builder to use for the string layout.</param>
        public LegacyCompletionFrameBuilder(LineStringBuilder lineStringBuilder)
        {
