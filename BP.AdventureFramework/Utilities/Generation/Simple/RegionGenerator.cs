...
namespace BP.AdventureFramework.Utilities.Generation.Simple
{
    ...
    public sealed class RegionGenerator : IRegionGenerator
    {
        ...
        public RegionMaker GenerateRegion(Identifier identifier, Description description, Random generator, IRoomGenerator roomGenerator, IItemGenerator takeableItemGenerator, IItemGenerator nonTakeableItemGenerator, GameGenerationOptions options)
        {
            var regionMaker = new RegionMaker(identifier, description);
